      ...
      <div className='w-11/12 mx-auto block sm:flex pt-0 md:pt-10 pb-10'>
        ...
        <div className='w-full sm:w-1/2'>
            ...
            <div className='mt-4 md:mt-16 text-base sm:text-xl md:text-4xl text-justify pr-0 sm:pr-14' style={{ fontFamily: '"Inter", monospace',
                          ...
                          Transform Your Logistics with Our Comprehensive Solutions
            </div>

            <div className='mt-4 md:mt-10 pr-0 sm:pr-8 md:pr-20 text-sm sm:text-base md:text-xl leading-2 md:leading-10 text-justify'>
            MPCL helps you transform your logistics operations with speed and efficiency. Our industry-leading technology ensures your products reach customers faster than ever. Trust us to deliver excellence in every step of the logistics process.
            </div>
       ...
       <div className='w-10/12 mx-auto pt-16 pb-10 flex items-center'>
           <div className='w-full sm:w-10/12 md:w-1/2'>
                ...
                <div>
                    ...
                    Navigating tomorrow, Max Transtech Limited aims to steer towards sustainable success by revolutionizing transportation with innovation, eco-friendly practices, and inclusivity, setting new industry benchmarks and positively impacting communities and the planet.
                    </p>
                </div>
                ...
                <div>
                    ...
                    At Max Transtech Limited, we revolutionize transportation with innovation and sustainability, aiming for 1000 crores in revenue by 2030. We prioritize customer satisfaction, embrace cutting-edge technologies, and integrate eco-friendly practices to positively impact communities and the planet.
                    </p>
                </div>
