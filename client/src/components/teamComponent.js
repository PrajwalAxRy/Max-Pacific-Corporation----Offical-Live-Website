        ...
        <div className=" max-w-72 bg-white border border-gray-200 rounded-lg shadow-md newhoverEffects">
            ...
            <div className="p-5">
                ...
                <div className=' mt-3 flex justify-between px-5'>
                    <FontAwesomeIcon icon={faTwitter}  className=' text-blue-500 size-6' onClick={onClickX}/>
                    <FontAwesomeIcon icon={faFacebook} className=' text-blue-800 size-6' onClick={onClickFacebook} />
                    <FontAwesomeIcon icon={faLinkedin}  className='text-blue-700 size-6' onClick={onClickLinkedIn} />
                </div>
            </div>
        </div>
    </div>
